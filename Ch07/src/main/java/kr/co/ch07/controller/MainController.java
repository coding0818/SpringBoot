...
public class MainController {
	...
	public String query2() {
		List<User1VO> users = repo.findUser1VOByName("김춘추");
	...
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("j101", "김춘추");
	...
	public String query6() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThan(80);
	...
	public String query7() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanEqual(80);
	...
	public String query8() {
		List<User1VO> users = repo.findUser1VOByAgeLessThan(25);
	...
	public String query17() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanOrderByAgeDesc(25);
	...
	public String query18() {
		int users = repo.countUser1VOByUid("j101");
	...
	public String query19() {
		int users = repo.countUser1VOByName("김춘추");
	...
	public String query21() {
		List<User1VO> users = repo.selectUserByName("김춘추");
	...
	public String query22() {
		List<User1VO> users = repo.selectUserByNameWithParam("김춘추");
