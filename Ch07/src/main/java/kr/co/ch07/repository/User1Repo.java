...
public interface User1Repo extends JpaRepository<User1VO, String>{
	...
	// like
	public List<User1VO> findUser1VOByNameLike(String name); // name 앞 또는 뒤 %(와일드카드) 명시
	public List<User1VO> findUser1VOByNameContains(String name);
	public List<User1VO> findUser1VOByNameStartsWith(String name); // 와일드카드가 뒤에 붙는 형태
	public List<User1VO> findUser1VOByNameEndsWith(String name); // 와일드카드가 앞에 붙는 형태
